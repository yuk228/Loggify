        ...
        <main>
            <div className="min-h-screen container mx-auto py-[100px]">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 md:px-8">
                    <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8">利用規約</h1>
                    <div className="space-y-4">
                        <p className="text-sm sm:text-base">この利用規約（以下，「本規約」といいます。）は，DeltaVerify（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。</p>
                        <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8">第1条（適用）</h2>
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8">第2条（禁止事項）</h2>
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8">第3条（本サービスの提供の停止等）</h2>
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8">第4条（保証の否認および免責事項）</h2>
                        <ol className="list-decimal list-inside space-y-2 ml-4 text-sm sm:text-base">
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8">第5条（サービス内容の変更等）</h2>
                        <p className="mb-4">当社は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
                        <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8">第6条（利用規約の変更）</h2>
                        <p className="mb-4">当社は以下の場合には、ユーザーの個別の同意を要せず、本規約を変更することができるものとします。</p>
                        <ol className="list-decimal list-inside space-y-2 ml-4 text-sm sm:text-base">
                            <li>本規約の変更がユーザーの一般の利益に適合するとき。</li>
                            <li>本規約の変更が本サービス利用契約の目的に反せず、かつ、変更の必要性、変更後の内容の相当性その他の変更に係る事情に照らして合理的なものであるとき。</li>
                        </ol>
                        <p className="mt-4">当社はユーザーに対し、前項による本規約の変更にあたり、事前に、本規約を変更する旨及び変更後の本規約の内容並びにその効力発生時期を通知します。</p>
                        <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8">第7条（権利義務の譲渡の禁止）</h2>
                        <p className="mb-4">ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
                        <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8">第8条（準拠法・裁判管轄）</h2>
                        <ol className="list-decimal list-inside space-y-2 ml-4 text-sm sm:text-base">
                            <li>本規約の解釈にあたっては，日本法を準拠法とします。</li>
                            <li>本サービスに関して紛争が生じた場合には，東京都を管轄する裁判所を専属的合意管轄とします。</li>
                        </ol>
                    </div>
                </div>
            </div>
