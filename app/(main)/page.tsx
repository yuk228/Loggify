...
const features = [
  {
    ...
    description:
      "Track verified users with comprehensive logging including account details, GPS and IP location data, and browser fingerprinting",
  },
  {
    icon: <UserCheck className="h-6 w-6" />,
    title: "Instant Backup",
    description:
      "Comprehensive backup solutions for both server data and member information, ensuring complete protection of your community assets",
  },
  {
    icon: <ShieldCheck className="h-6 w-6" />,
    title: "High Security",
    description:
      "Enhanced security with anti-bot protection through captcha and code obfuscation. Includes capabilities to block VPNs, proxies, and detect alternate accounts",
  },
];
...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-zinc-900 via-black to-zinc-900 text-white">
      <section className="container mx-auto px-4 pt-[300px] pb-16 text-center relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-white text-left mb-2">{feature.title}</h3>
