      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col gap-4 mb-6">
            <Button variant="outline" className="w-full" onClick={() => signIn("github")} disabled={false}>
            ...
            <Button variant="outline" className="w-full" onClick={() => signIn("google")} disabled={true}>
