    ...
    <div className="w-full h-full p-4 overflow-y-auto">
      <div className="flex items-center justify-center mb-4">
        <Avatar className="h-20 w-20">
          <AvatarImage
            src={`https://cdn.discordapp.com/avatars/${user.user_id}/${user.avatar_id}.png`}
          />
          <AvatarFallback className="text-xl">{user.global_name?.charAt(0)}</AvatarFallback>
        </Avatar>
      </div>
      ...
      <div className="space-y-4">
        <div className="border-b pb-2">
          <h4 className="flex font-semibold mb-2">
            <span className="mr-2">
              <User />
            </span>
            UserInfo
